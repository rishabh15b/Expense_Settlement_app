...
export function splitwise(transactions) {
    ...
    for (var i = 0; i < transactions.length; i++) {
        ...
        //person 1 is the payer so under a credit
        //person 2 is the payee so under a debit
        if (e.person1 in net_balance) {
            //check wheather e.person1 is present in hashmap or not
    ...
    var positive = {};  //geap of credit holders
